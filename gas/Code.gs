...
function setupConfigSheet() {
  try {
    ...
    var rows = [
      ...
      ['BANNER_YOUTUBE',   '',     'ID o URL de YouTube (ej: https://youtu.be/xxxx). RECOMENDADO para video. Prioridad máxima.'],
      ['BANNER_VIDEO',     '',     'URL directa de video MP4 (NO Drive). Solo si no usas YouTube.'],
